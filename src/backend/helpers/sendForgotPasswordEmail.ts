  ...
  const Mail = `<!DOCTYPE html>
    ...
    <body>
        <div class="email-container">
            ...
            <div class="content">
                <p>Hello, ${username}</p>
                <p>We received a request to Forgot your password. Click the button below to Forgot your password or enter the code manually.</p>
                 <div class="verification-code">${verifyCode}</div>
                <a href="${baseUrl}/verify-forgot-password?identifier=${email}&verifyCode=${verifyCode}" 
                class="reset-button">Forgot Password</a>
